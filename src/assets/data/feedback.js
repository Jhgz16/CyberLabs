...
function getFeedback(question, userAnswer) {
    ...
    switch (question.difficulty) {
      ...
      case 'Highly Technical':
        explanation += `
          ...
          <li>For safety, contact the service provider using known contacts.</li>
        `;
        break;
      case 'Highly Technical Extremely Difficult':
        explanation += `
          <li>Impressive! You mastered a complex scam detection.</li>
          <li>This ${category.toLowerCase()} employs advanced techniques like zero-width characters or DNS spoofing.</li>
  ...
  // Append category and complete the feedback
