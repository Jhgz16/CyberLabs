    ...
    .then(results => {
      ...
      window.exercisesData = {
        phish: [
          ...
          { text: 'An SMS from Shopee claims you’ve won a P5,000 voucher and provides a link to claim it. Is this legitimate?', smsContent: { from: 'Shopee PH', body: 'Shopee Alert: You’ve won a P5,000 voucher! Claim at https://sh0pee.com/claim by May 20, 2025.', maskedUrl: 'https://shopee-fake-voucher.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Homoglyph "0" mimics "o", masked URL. Shopee uses shopee.ph.' },
          { text: 'An SMS from Lazada says your package is on hold due to a payment issue and provides a link to resolve it. Is this safe?', smsContent: { from: 'Lazada PH', body: 'Lazada Alert: Your package is on hold due to a payment issue. Resolve at https://lazàda.com/resolve by May 20, 2025.', maskedUrl: 'https://lazada-fake-payment.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "à" mimics "a", masked URL. Lazada uses lazada.com.ph.' }
        ],
        netsec: [
