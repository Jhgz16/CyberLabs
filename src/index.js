    ...
    .then(results => {
      ...
      window.exercisesData = {
        phish: [
          ...
          // SMS Phishing (Smishing) (8 questions)
          ...
          // Other Phishing Vectors (Vishing, Whaling, Zishing, etc.) (25 questions)
          { text: 'A call from BDO Unibank claims there’s an issue with your account and asks for your OTP to resolve it. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'BDO never asks for OTPs over the phone. Report to reportphish@bdo.com.ph.' },
          { text: 'A Zoom meeting invite from your company’s IT team asks you to join a session to update software, with a link. Is this safe?', options: ['Legitimate', 'Zishing'], correctAnswer: 'Zishing', difficulty: 'Highly Technical', explanation: 'Zishing targets video conferencing users. Verify invites directly with IT.' },
          { text: 'A call from Facebook security claims your account was hacked and requests your password to secure it. Is this legitimate?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'Facebook never asks for passwords over the phone. Secure via facebook.com.' },
          { text: 'An email to your CEO from a vendor requests urgent payment for an invoice, claiming a deal will expire. What is this?', options: ['Legitimate', 'Whaling'], correctAnswer: 'Whaling', difficulty: 'Highly Technical', explanation: 'Whaling targets executives with urgent requests. Verify directly with the vendor.' },
          { text: 'A Microsoft Teams message from HR asks you to join a meeting to discuss a promotion, with a link. Is this safe?', options: ['Legitimate', 'Zishing'], correctAnswer: 'Zishing', difficulty: 'Highly Technical', explanation: 'Zishing via Teams mimics legit invites. Verify with HR directly.' },
          { text: 'A call from the IRS claims you owe taxes and threatens legal action unless you pay immediately. Is this legitimate?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'IRS never demands payment over the phone. Verify via irs.gov.' },
          { text: 'A WhatsApp message from a friend shares a link to a great deal, but their account was recently compromised. What is this?', options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Medium', explanation: 'Compromised accounts often send phishing links. Verify with your friend offline.' },
          { text: 'A call from Geek Squad (used in 19% of hybrid vishing attacks) claims you’ve been charged for a service and offers a refund if you call back. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Highly Technical', explanation: 'Hybrid vishing starts with a call prompting a callback. Geek Squad is often impersonated.' },
          { text: 'A LinkedIn message from a recruiter offers a job interview via a Zoom link. Is this legitimate?', options: ['Legitimate', 'Zishing'], correctAnswer: 'Zishing', difficulty: 'Highly Technical', explanation: 'Zishing via LinkedIn uses fake invites. Verify the recruiter’s identity.' },
          { text: 'A call from your bank (Citibank) asks for your account details to verify a transaction. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'Banks never request account details over the phone. Verify via citibank.com.' },
          { text: 'A spear phishing email to your CFO mimics a trusted vendor, requesting a wire transfer. What is this?', options: ['Legitimate', 'Whaling'], correctAnswer: 'Whaling', difficulty: 'Extremely Highly Technical', explanation: 'Whaling targets executives with spear phishing. Verify all payment requests.' },
          { text: 'A call from Amazon claims you’ve been charged for a subscription and asks for your payment details to refund. Is this legitimate?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'Amazon doesn’t request payment details over the phone. Verify via amazon.com.' },
          { text: 'A Google Meet invite from your boss asks you to join a performance review session. Is this safe?', options: ['Legitimate', 'Zishing'], correctAnswer: 'Zishing', difficulty: 'Highly Technical', explanation: 'Zishing mimics legit invites. Confirm with your boss directly.' },
          { text: 'A call from PayPal (38% of hybrid vishing attacks) claims a payment issue and asks you to confirm your details. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Highly Technical', explanation: 'PayPal is a top vishing target. Never share details over the phone.' },
          { text: 'A spear phishing email to your HR manager mimics the CEO, requesting employee payroll data. What is this?', options: ['Legitimate', 'Whaling'], correctAnswer: 'Whaling', difficulty: 'Extremely Highly Technical', explanation: 'Whaling targets high-level staff with impersonation. Verify with the CEO.' },
          { text: 'A call from Norton/LifeLock (19% of vishing attacks) claims your subscription needs renewal and asks for payment. Is this legitimate?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Highly Technical', explanation: 'Norton/LifeLock is often impersonated in vishing. Verify via norton.com.' },
          { text: 'A WhatsApp message from a colleague shares a link to a company survey, but their account was hacked. What is this?', options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Medium', explanation: 'Hacked accounts send phishing links. Verify with the colleague offline.' },
          { text: 'A call from the Social Security Administration claims your benefits are suspended and asks for your SSN. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'SSA never requests SSNs over the phone. Verify via ssa.gov.' },
          { text: 'A Zoom invite from a client asks you to join a project update meeting. Is this legitimate?', options: ['Legitimate', 'Zishing'], correctAnswer: 'Zishing', difficulty: 'Highly Technical', explanation: 'Zishing uses fake invites. Verify with the client directly.' },
          { text: 'A spear phishing email to your CTO mimics a board member, requesting sensitive company data. What is this?', options: ['Legitimate', 'Whaling'], correctAnswer: 'Whaling', difficulty: 'Extremely Highly Technical', explanation: 'Whaling targets executives with impersonation. Verify with the board member.' },
          { text: 'A call from McAfee (19% of vishing attacks) claims your antivirus subscription expired and asks for payment. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Highly Technical', explanation: 'McAfee is often impersonated in vishing. Verify via mcafee.com.' },
          { text: 'A Microsoft Teams invite from a partner company asks you to join a collaboration meeting. Is this safe?', options: ['Legitimate', 'Zishing'], correctAnswer: 'Zishing', difficulty: 'Highly Technical', explanation: 'Zishing mimics legit invites. Verify with the partner directly.' },
          { text: 'A call from your ISP claims there’s an issue with your account and asks for your login details. Is this legitimate?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'ISPs don’t request login details over the phone. Verify directly.' },
          { text: 'A spear phishing email to your finance director mimics a supplier, requesting payment for an overdue invoice. What is this?', options: ['Legitimate', 'Whaling'], correctAnswer: 'Whaling', difficulty: 'Extremely Highly Technical', explanation: 'Whaling targets finance staff with fake invoices. Verify with the supplier.' },
          { text: 'A call from a utility company claims you owe a balance and threatens to cut off service unless you pay now. Is this safe?', options: ['Legitimate', 'Vishing'], correctAnswer: 'Vishing', difficulty: 'Medium', explanation: 'Utility companies don’t demand payment over the phone. Verify directly.' }
        ],
        netsec: [
