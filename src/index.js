  ...
  Promise.all(jsonFiles.map(src => loadJson(src)))
    .then(results => {
      ...
      window.exercisesData = {
        phish: [
          // Email Phishing (17 questions, retained from previous)
          ...
          // SMS Phishing (Smishing) (8 questions, retained from previous)
          ...
          // New Email Phishing (15 questions, replacing "Other Vectors")
          { text: 'An email from Shopee claims you’ve won a P10,000 voucher and provides a link to claim it. Is this legitimate?', emailContent: { from: 'promo@sh0pee.com', subject: 'Congratulations! Claim Your P10,000 Shopee Voucher by May 20, 2025', body: 'Dear Shopper,<br><br>You’ve won a P10,000 voucher from Shopee! Claim it now:<br><br><a href="#">https://sh0pee.com/claim-voucher</a><br><br>Offer expires May 20, 2025.<br><br>Best,<br>Shopee Team', maskedUrl: 'https://shopee-voucher-fake.com' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Medium', explanation: 'Homoglyph "0" mimics "o", masked URL. Shopee uses shopee.ph.' },
          ...
          { text: 'An SMS from TikTok claims you’ve been selected for a P10,000 creator reward and provides a link to claim it. Is this legitimate?', smsContent: { from: 'TikTok PH', body: 'TikTok Alert: You’ve been selected for a P10,000 creator reward! Claim at https://tìktok.com/claim-reward by May 20, 2025.', maskedUrl: 'https://tiktok-fake-reward.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Extremely Highly Technical', explanation: 'Homoglyph "ì" mimics "i", masked URL. TikTok uses tiktok.com.' },
          { text: 'An SMS claims you’ve won a P2,000 Shopee voucher from a survey and asks you to claim it via a link. Is this safe?', smsContent: { from: '+639876543210', body: 'Congrats! You’ve won a P2,000 Shopee voucher from our survey! Claim at https://sh0pee.com/survey-voucher by May 20, 2025.', maskedUrl: 'https://shopee-survey-fake.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Homoglyph "0" mimics "o", masked URL. Shopee uses shopee.ph.' },
          { text: 'An SMS from Lazada offers a free P1,000 voucher for your next purchase if you click a link to claim it. Is this legitimate?', smsContent: { from: 'Lazada PH', body: 'Lazada Offer: Get a free P1,000 voucher! Claim at https://lazàda.com/free-voucher by May 20, 2025.', maskedUrl: 'https://lazada-free-voucher-fake.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Homoglyph "à" mimics "a", masked URL. Lazada uses lazada.com.ph.' },
          { text: 'An SMS from a Philippine charity claims you’ve won a P10,000 donation voucher and asks you to claim it via a link. Is this safe?', smsContent: { from: 'Charity PH', body: 'Charity Alert: You’ve won a P10,000 donation voucher! Claim at https://charìty-ph.com/claim by May 20, 2025.', maskedUrl: 'https://charity-fake-donation.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Homoglyph "ì" mimics "i", masked URL. Verify charities directly.' },
          { text: 'An SMS from Smart PH claims your bill is overdue and provides a link to pay to avoid disconnection. Is this legitimate?', smsContent: { from: 'Smart PH', body: 'Smart Alert: Your bill is overdue! Pay at https://smàrt.com.ph/pay-bill by May 20, 2025 to avoid disconnection.', maskedUrl: 'https://smart-fake-pay.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "à" mimics "a", masked URL. Smart uses smart.com.ph.' },
          { text: 'An SMS from Globe PH offers a free 2GB data bundle if you verify your account via a link. Is this safe?', smsContent: { from: 'Globe PH', body: 'Globe Offer: Get a free 2GB data bundle! Verify at https://gl0be.com.ph/free-data by May 20, 2025.', maskedUrl: 'https://globe-fake-data.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "0" mimics "o", masked URL. Globe uses globe.com.ph.' },
          { text: 'An SMS from a Philippine online casino claims you’ve won P20,000 and asks you to claim it via a link. Is this legitimate?', smsContent: { from: 'Casino PH', body: 'Casino Alert: You’ve won P20,000! Claim at https://casìno-ph.com/claim-win by May 20, 2025.', maskedUrl: 'https://casino-fake-claim.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Homoglyph "ì" mimics "i", masked URL. Verify casinos directly.' },
          { text: 'An SMS from Cebu Pacific claims you’ve won a free round-trip ticket and provides a link to claim it. Is this safe?', smsContent: { from: 'Cebu Pacific', body: 'Cebu Pacific Alert: You’ve won a free round-trip ticket! Claim at https://cebu-pacìfic.com/claim-ticket by May 20, 2025.', maskedUrl: 'https://cebu-fake-ticket.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "ì" mimics "i", masked URL. Cebu Pacific uses cebupacificair.com.' }
        ],
        netsec: [
