  ...
  Promise.all(jsonFiles.map(src => loadJson(src)))
    .then(results => {
      ...
      window.exercisesData = {
        phish: [
          { text: 'You receive an email in Gmail. Is it legitimate?', emailContent: { from: 'support@paypa1.com', subject: 'Urgent: Account Verification', body: 'Your PayPaI account needs verification. Click here: paypa1.com/verify' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Medium', explanation: 'The homoglyph "1" mimics "l" in "paypa1.com" and "PayPaI", a phishing tactic. PayPal uses paypal.com. Avoid clicking links.' },
          ...
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'no-reply@amazon-dea1s2025.com', subject: 'Order Confirmation #XYZ123', body: 'Your Amazon order is confirmed. Track here: amazon-dea1s2025.com/track' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The homoglyph "1" replaces "l" in "dea1s", and the domain mimics Amazon. Verify on amazon.com.' },
          ...
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'promo@shopee-prom0.com', subject: 'Win P5000!', body: 'Claim your prize: bit.ly/sh0pee-promo' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "0" mimics "o", and the shortened URL hides the site. Shopee uses shopee.ph. Verify directly.' },
          ...
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'tax@irs.gov.ph', subject: 'Tax Payment Due', body: 'Pay $2000 by May 20, 2025. Click: irs-payment.gov.ph' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The ".gov.ph" is suspicious (IRS uses .gov). This is a whaling attack targeting officials. Verify via irs.gov.' },
          ...
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'support@gmaìl.com', subject: 'Account Security Alert', body: 'Your account is at risk. Verify: gmaìl.com/security' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The homoglyph "ì" mimics "i" in "gmaìl.com". This is a spear phishing attack. Use accounts.google.com.' },
          ...
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'ceo@company.c0m', subject: 'Urgent: Wire Transfer', body: 'Approve $50,000 transfer by EOD. Link: company.c0m/approve' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "0" mimics "o" in "c0m", a whaling attack targeting executives. Verify with the CEO directly.' },
          ...
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'support@amazon.com', subject: 'Order Shipped', body: 'Your order #ABC123 shipped. Track: amazon.com/track' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "amazon.com" and context match Amazon’s official communication. This is legitimate.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: '+639178901234', body: 'Globe: Your bill is due. Pay at globe.com.ph/bill' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "globe.com.ph" and official tone are valid. This is a legitimate reminder.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'security@gmai1.com', subject: 'Login Attempt', body: 'Unusual login from Philippines. Secure: gmai1.com/login' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "1" mimics "l" in "gmai1.com". Gmail uses accounts.google.com. This is phishing.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'PayPal', body: 'Your payment of $50 succeeded. Details: paypal.com/receipt' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "paypal.com" and payment context are valid. This is a legitimate receipt.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'hr@compaпy.com', subject: 'New Policy', body: 'Review policy at compaпy.com/policy' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "п" (Cyrillic) mimics "n" in "compaпy.com". This is spear phishing. Verify with HR.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'DHL', body: 'Package delivered. Confirm at dhl.com/track' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "dhl.com" and delivery context are valid. This is legitimate.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'admin@netf1ix.com', subject: 'Account Update', body: 'Update payment: netf1ix.com/bill' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "1" mimics "l" in "netf1ix.com". Netflix uses netflix.com. This is phishing.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: '+12025550123', body: 'Shopee: Order #123 shipped. Track at shopee.ph' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "shopee.ph" and order context are valid. This is legitimate.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'support@gmaïl.com', subject: 'Security Alert', body: 'Login from new device. Secure: gmaïl.com' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "ï" mimics "i" in "gmaïl.com". Gmail uses accounts.google.com. This is phishing.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'GCash', body: 'Transaction of P500 confirmed. Check: gcash.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "gcash.com" and confirmation are valid. This is legitimate.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'ceo@compɑny.com', subject: 'Urgent Action', body: 'Approve $100,000 transfer: compɑny.com/approve' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "ɑ" mimics "a" in "compɑny.com", a whaling attack. Verify with the CEO.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'BDO', body: 'Your statement is ready. View: bdo.com.ph/statement' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "bdo.com.ph" and statement context are valid. This is legitimate.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'support@pɑypal.com', subject: 'Account Locked', body: 'Unlock: pɑypal.com/unlock' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "ɑ" mimics "a" in "pɑypal.com". PayPal uses paypal.com. This is phishing.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: '+639178901234', body: 'Amazon: Order delayed. Track at amazon.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "amazon.com" and delay notice are valid. This is legitimate.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'admin@rnicrosoft.com', subject: 'Software Update', body: 'Install update: rnicrosoft.com/update' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "rn" mimics "m" in "rnicrosoft.com", targeting Microsoft users. Verify at microsoft.com.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'PayPal', body: 'Your $20 payment failed. Fix: paypal.com/pay' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "paypal.com" and payment context are valid. This is legitimate.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'security@gmaìl.com.ph', subject: 'Login Alert', body: 'Verify: gmaìl.com.ph/login' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "ì" mimics "i", and ".com.ph" is suspicious. Gmail uses accounts.google.com.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'DHL', body: 'Shipment #XYZ123 delivered. Check: dhl.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "dhl.com" and delivery context are valid. This is legitimate.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'support@nètflix.com', subject: 'Billing Issue', body: 'Resolve: nètflix.com/bill' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "è" mimics "e" in "nètflix.com". Netflix uses netflix.com. This is phishing.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: '+12025550123', body: 'Globe: New offer at globe.com.ph' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "globe.com.ph" and offer context are valid. This is legitimate.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'hr@compаny.org', subject: 'Payroll Update', body: 'Details: compаny.org/payroll' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "а" mimics "a" in "compаny.org", a spear phishing attempt. Verify with HR.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'Shopee', body: 'Order #456 confirmed. Track: shopee.ph' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "shopee.ph" and order context are valid. This is legitimate.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'admin@gmaìl.org', subject: 'Password Reset', body: 'Reset: gmaìl.org/reset' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "ì" mimics "i", and ".org" is suspicious. Gmail uses accounts.google.com.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'BDO', body: 'Your loan approved. Login: bdo.com.ph' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "bdo.com.ph" and loan context are valid. This is legitimate.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'ceo@compаny.net', subject: 'Confidential', body: 'Send $10,000: compаny.net/transfer' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "а" mimics "a", a whaling attack. Verify with the CEO.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: 'PayPal', body: 'Refund of $30 processed. Check: paypal.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "paypal.com" and refund context are valid. This is legitimate.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'support@amɑzon.com', subject: 'Account Review', body: 'Review: amɑzon.com/review' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "ɑ" mimics "a" in "amɑzon.com". Amazon uses amazon.com. This is phishing.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'GCash', body: 'P1000 added. Details: gcash.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "gcash.com" and addition context are valid. This is legitimate.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'security@nètflix.net', subject: 'Login Blocked', body: 'Unblock: nètflix.net/unblock' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "è" mimics "e", and ".net" is suspicious. Netflix uses netflix.com.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'DHL', body: 'Tracking #DEF456 updated. Check: dhl.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "dhl.com" and tracking context are valid. This is legitimate.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'admin@gmɑil.com', subject: 'Security Update', body: 'Update: gmɑil.com/update' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "ɑ" mimics "a" in "gmɑil.com". Gmail uses accounts.google.com.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: 'Shopee', body: 'Promo: 20% off at shopee.ph/promo' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "shopee.ph" and promo context are valid. This is legitimate.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'support@pɑypɑl.com', subject: 'Fraud Alert', body: 'Secure: pɑypɑl.com/secure' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "ɑ" mimics "a" in "pɑypɑl.com". PayPal uses paypal.com. This is phishing.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'BDO', body: 'Account alert. Login: bdo.com.ph/login' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "bdo.com.ph" and alert context are valid. This is legitimate.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'hr@compаny.co', subject: 'Tax Form', body: 'Submit: compаny.co/tax' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "а" mimics "a", a spear phishing attempt. Verify with HR.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'PayPal', body: 'Payment $100 approved. View: paypal.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "paypal.com" and payment context are valid. This is legitimate.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'ceo@rnicrosoft.net', subject: 'Urgent Memo', body: 'Act now: rnicrosoft.net/memo' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "rn" mimics "m" in "rnicrosoft.net". Microsoft uses microsoft.com. This is whaling.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: 'GCash', body: 'Cash-in of P200. Check: gcash.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "gcash.com" and cash-in context are valid. This is legitimate.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'admin@gmɑi1.com', subject: 'Login Warning', body: 'Secure: gmɑi1.com/warning' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'The "ɑ" and "1" mimic "a" and "l". Gmail uses accounts.google.com.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'Shopee', body: 'Order #789 shipped. Track: shopee.ph' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "shopee.ph" and shipping context are valid. This is legitimate.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'security@nètflìx.com', subject: 'Account Issue', body: 'Fix: nètflìx.com/fix' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'The "è" and "ì" mimic "e" and "i". Netflix uses netflix.com. This is phishing.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'DHL', body: 'Delivery scheduled. Confirm: dhl.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Legitimate', difficulty: 'Medium', explanation: 'The domain "dhl.com" and delivery context are valid. This is legitimate.' }
        ],
        netsec: [
