          ...
          React.createElement('p', {
            dangerouslySetInnerHTML: {
              __html: question.emailContent.body.replace(
                /https?:\/\/[^\s]+/g,
                url => `<a href="#" onclick="window.open('${url}', '_blank', 'noopener,noreferrer'); return false;" style="color: blue; text-decoration: underline;" title="${url}" class="masked-link">${question.emailContent.maskedUrl || url}</a>`
              )
            }
          })
        )
          ...
          React.createElement('p', {
            dangerouslySetInnerHTML: {
              __html: question.smsContent.body.replace(
                /https?:\/\/[^\s]+/g,
                url => `<a href="#" onclick="window.open('${url}', '_blank', 'noopener,noreferrer'); return false;" style="color: blue; text-decoration: underline;" title="${url}" class="masked-link">${question.smsContent.maskedUrl || url}</a>`
              )
            }
          })
        )
  ...
  Promise.all(jsonFiles.map(src => loadJson(src)))
    .then(results => {
      ...
      window.exercisesData = {
        phish: [
          { text: 'You receive an email in Gmail. Is it legitimate?', emailContent: { from: 'support@paypa1.com', subject: 'Urgent: Account Verification', body: 'Your PayPaI account needs verification. Click here: <a href="#" onclick="window.open(\'https://paypa1.com/verify\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://paypa1.com/verify" class="masked-link">https://secure.paypal-login.com</a>', maskedUrl: 'https://secure.paypal-login.com' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Medium', explanation: 'Homoglyph "1" mimics "l", masked URL hides phishing site. PayPal uses paypal.com.' },
          { text: 'An SMS arrives on your phone. Is it safe?', smsContent: { from: '+639123456789', body: 'Your BDO card is locked. Reply YES or visit <a href="#" onclick="window.open(\'https://bdo-on1ine.com/unlock\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://bdo-on1ine.com/unlock" class="masked-link">https://bdo-bank.online</a>', maskedUrl: 'https://bdo-bank.online' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Homoglyph "1" mimics "l", link shim hides real URL. BDO uses bdo.com.ph.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'no-reply@amazon-dea1s2025.com', subject: 'Order Confirmation #XYZ123', body: 'Your Amazon order is confirmed. Track here: <a href="#" onclick="window.open(\'https://amazon-dea1s2025.com/track\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://amazon-dea1s2025.com/track" class="masked-link">https://amazon.order-tracking.org</a>', maskedUrl: 'https://amazon.order-tracking.org' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "1" replaces "l", masked URL mimics Amazon. Verify on amazon.com.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'GCash Support', body: 'Low balance alert. Top up at <a href="#" onclick="window.open(\'https://gcash-support.net/topup\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://gcash-support.net/topup" class="masked-link">https://secure.gcash-login.net</a>', maskedUrl: 'https://secure.gcash-login.net' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'Link shim and fake domain. GCash uses gcash.com.' },
          { text: 'A Gmail email arrives. Is it safe?', emailContent: { from: 'promo@shopee-prom0.com', subject: 'Win P5000!', body: 'Claim your prize: <a href="#" onclick="window.open(\'https://bit.ly/sh0pee-promo\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://bit.ly/sh0pee-promo" class="masked-link">https://shopee-promotions.ph</a>', maskedUrl: 'https://shopee-promotions.ph' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "0" mimics "o", shortened URL with mask. Shopee uses shopee.ph.' },
          { text: 'An SMS appears. Is it legitimate?', smsContent: { from: 'DHL Tracking', body: 'Your package is delayed. Track at <a href="#" onclick="window.open(\'https://dhl-tracking.org/status\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://dhl-tracking.org/status" class="masked-link">https://dhl-delivery-service.com</a>', maskedUrl: 'https://dhl-delivery-service.com' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Medium', explanation: 'URL masking hides phishing site. DHL uses dhl.com.' },
          { text: 'You receive a Gmail email. What is it?', emailContent: { from: 'tax@irs.gov.ph', subject: 'Tax Payment Due', body: 'Pay $2000 by May 20, 2025. Click: <a href="#" onclick="window.open(\'https://irs-payment.gov.ph/pay\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://irs-payment.gov.ph/pay" class="masked-link">https://secure-tax.us.gov</a>', maskedUrl: 'https://secure-tax.us.gov' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Highly Technical', explanation: 'Fake ".gov.ph", masked URL mimics IRS. Verify via irs.gov.' },
          { text: 'An SMS arrives. Is it safe?', smsContent: { from: '+12025550123', body: 'Netflix billing issue. Update at <a href="#" onclick="window.open(\'https://netf1ix.com/bill\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://netf1ix.com/bill" class="masked-link">https://netflix-billing.support</a>', maskedUrl: 'https://netflix-billing.support' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "1" mimics "l", masked URL. Netflix uses netflix.com.' },
          { text: 'A Gmail email appears. Is it trustworthy?', emailContent: { from: 'support@gmaìl.com', subject: 'Account Security Alert', body: 'Your account is at risk. Verify: <a href="#" onclick="window.open(\'https://gmaìl.com/security\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://gmaìl.com/security" class="masked-link">https://accounts.google-login.com</a>', maskedUrl: 'https://accounts.google-login.com' }, options: ['Legitimate', 'Phishing'], correctAnswer: 'Phishing', difficulty: 'Extremely Highly Technical', explanation: 'Homoglyph "ì" mimics "i", masked URL mimics Google. Use accounts.google.com.' },
          { text: 'You get an SMS. What is it?', smsContent: { from: 'Globe PH', body: 'Your load expires. Recharge at <a href="#" onclick="window.open(\'https://gl0be.com.ph/recharge\', \'_blank\', \'noopener,noreferrer\'); return false;" style="color: blue; text-decoration: underline;" title="https://gl0be.com.ph/recharge" class="masked-link">https://globe-mobile.topup</a>', maskedUrl: 'https://globe-mobile.topup' }, options: ['Legitimate', 'Smishing'], correctAnswer: 'Smishing', difficulty: 'Highly Technical', explanation: 'Homoglyph "0" mimics "o", masked URL. Globe uses globe.com.ph.' }
        ],
        netsec: [
